            ...
            <div className="hidden bg-cover lg:block lg:w-2/5 bg-[url('../../public/images/login-image.png')]">
                <div className="flex items-center h-full px-20 bg-gray-900 bg-opacity-40">
                    <div>
                        ...
                        <p className="max-w-xl mt-6 text-gray-300 ml-6">Please login to your personal account to continue your wedding plan.</p>
                        <Link href="/auth/login" passHref={true}>
                            <button className="btn bg-white text-black rounded-full ml-6 mt-6 pb-7 pt-4 px-12 border-white hover:bg-slate-100 hover:border-white">Log In</button>
                        </Link>
                    </div>
                </div>
            </div>
